...
public class ListaSEService {
    ...
    public ListaSEService() {
        ...
        kids = new ListaSE();
        kids.addKidToEnd(new Kid("1006", "Valeria Osorio", (byte) 20,"Female","Cartago"));
        kids.addKidToEnd(new Kid("1007", "Jhair Torres", (byte)18 ,"Male","Florencia"));
        kids.addKidToEnd(new Kid("1003", "John Jaime", (byte) 18,"Male","Manizales"));
        kids.addKidToEnd(new Kid("1004", "Sergio Nuñez", (byte) 19,"Male","Pitalito"));
        kids.addKidToEnd(new Kid("1008", "Sebastian Rugeles", (byte) 19,"Male","Manizales"));
